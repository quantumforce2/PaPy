...
class PApy:
    ...
    def get_cube_names(self, showcontrolobjects = False):
        # url = "https://tm1-plan-ah-qa.edf.nikecloud.net:30009/api/v1/Cubes?$select=Name"
    ...
    def get_dimension_names_from_cube(self, cubename):
        # https://tm1-plan-ah-qa.edf.nikecloud.net:30009/api/v1/Cubes('Plan_Consolidated')/Dimensions?$select=Name
    ...
    def get_native_view(self, cubename, viewname):
        # url = "https://tm1-plan-ah-qa.edf.nikecloud.net:30009/api/v1/Cubes('Plan_Gross_To_Net')/Views('zMs_Test')/tm1.Execute?$expand=Axes($expand=Hierarchies($select=Name),Tuples($expand=Members($select=Name))),Cells"
